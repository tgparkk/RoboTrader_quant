...
사용 예시:
    ...
    run_parser.add_argument('--profit', type=float, default=0.15,
                            help='익절률 (기본: 0.15)')
    run_parser.add_argument('--loss', type=float, default=0.08,
                            help='손절률 (기본: 0.08)')
    ...
    all_parser.add_argument('--profit', type=float, default=0.15,
                            help='익절률 (기본: 0.15)')
    all_parser.add_argument('--loss', type=float, default=0.08,
                            help='손절률 (기본: 0.08)')
    ...
    regime_parser.add_argument('--profit', type=float, default=0.15,
                               help='익절률 (기본: 0.15)')
    regime_parser.add_argument('--loss', type=float, default=0.08,
                               help='손절률 (기본: 0.08)')
